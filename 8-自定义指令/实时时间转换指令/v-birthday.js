var Birthday={
    ...
    //转换时间
    getFormatBirthday:function(timestamp){
        //获取当前时间的年份、月份、天数
        //获取出生的年、月、日
        //需要判断 例如 7月28 和 8月1号 ，不满一个月，主要是判断逻辑。懒得搞了
...
Vue.directive('birthday',{
    bind:function(el,binding){
        //第一次会延迟5秒
        el.innerHTML=Birthday.getFormatBirthday(binding.value),
        el.__timeout__=setInterval(function(){
            el.innerHTML=Time.getFormatBirthday(binding.value);
        },30000);
    },
    unbind:function(el){
